...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, game_configs_dict):
        ...
        self.walk_r = sf.get_surface_from_spritesheet(
            'assets\graphics\movimientos\enemigo-caminar\enemigo-caminar.png', 5, 1)
        self.walk_l = sf.get_surface_from_spritesheet(
            'assets\graphics\movimientos\enemigo-caminar\enemigo-caminar.png', 5, 1, True)
    ...
    # Verificar la dirección directamente, sin usar self.direccion
